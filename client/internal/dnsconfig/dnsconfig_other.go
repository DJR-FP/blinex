...
// Apply is not yet implemented outside Linux — Windows/macOS support is a
// deliberate next step, not an oversight (see the roadmap). Magic DNS and
// domain filtering still work if the OS is pointed at the resolver manually.
